...
{
    public class PathExplorerMssqlDbContext : DbContext
    {
        private readonly IDateTimeService _dateTimeService;

        public PathExplorerMssqlDbContext(DbContextOptions<PathExplorerMssqlDbContext> options,  IDateTimeService dateTimeService) : base(options)
        {
