...
{
    public class PathExplorerDbContext : DbContext
    {
        private readonly IDateTimeService _dateTimeService;

        public PathExplorerDbContext(DbContextOptions<PathExplorerDbContext> options,  IDateTimeService dateTimeService) : base(options)
        {
